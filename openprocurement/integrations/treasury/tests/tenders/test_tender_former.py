...
class TestUtils(TestCase):
    ...
    def test_create_tender_former(self):
        tender_former = TenderFormer()

    def test_create_xml_from_data(self):
        Tender = namedtuple('Tender', ['contract_id', 'tender_id', 'identifier_id', 'contract_number', 
                                       'date_signed', 'contracts_amount', 'currency', 'vat_included',
                                       'documents', 'bids'])
        tender = Tender('123', '123', '123', '123', '123', '123', '123', '123', 
                        ['file1', 'file2'], ['bid1', 'bid2'])
        tender_former = TenderFormer()
        tender_former.form_xml_to_post(tender, 'request_id')
